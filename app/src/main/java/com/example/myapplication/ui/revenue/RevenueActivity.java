...
//
//        // So sánh phiên bản cơ sở dữ liệu đã lưu với phiên bản hiện tại
//        if (savedDbVersion < currentDbVersion) {
//            // Phiên bản cơ sở dữ liệu mới hơn, cần chèn dữ liệu mẫu
//
//            // Xóa dữ liệu cũ trong các bảng cần reset
//            // Thêm dữ liệu mẫu mới
//            dbHelper.insertSampleData();
//            dbHelper.insertSampleUsers();
//            dbHelper.insertSampleBillData();
//
//            // Cập nhật phiên bản cơ sở dữ liệu mới vào SharedPreferences
//            prefs.edit()
